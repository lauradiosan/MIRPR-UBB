...
1. Project Image processing for prostate cancer
2. Project Classification of prostate biopsy
3. Project Image processing for breast cancer
4. Project Image processing for bladder cancer
5. Project Image processing for dental data
6. Project Image processing for Emergency Room
7. Project Smart agriculture
8. Project Large Image processing for breast cancer
9. Project Autonomated driving
...
In realizarea aplicatiei se pot folosi diferite limbaje de programare, tehnologii si instrumente specifice AI. Codebase-urile aferente aplicatiilor trebuie incarcate, inainte de expirarea termenelor, [aici](https://classroom.github.com/a/nc3HHviX).
